...
const styles = StyleSheet.create({
  ...
  hero: {
    backgroundColor: `linear-gradient(180deg, ${COLORS.pink} 0%, ${COLORS.pinkDark} 100%)`,
    paddingVertical: 30,
    ...
    <View style={styles.container}>
      <ScrollView style={styles.content}>
        ...
        <View style={styles.heroBg}>
          ...
          <Text style={styles.memberBadge}>⭐ Miembro</Text>
        </View>
        ...
        >
          ...
          <Text style={{ color: COLORS.pink, fontWeight: TYPOGRAPHY.weights.extrabold }}>
            Cerrar Sesión
          </Text>
        </TouchableOpacity>
